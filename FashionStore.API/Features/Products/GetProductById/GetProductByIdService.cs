...
public class GetProductByIdService(IProductRepository repository, IImageProcessor imageProcessor, ICloudinaryImageService cloudinary, ILogger<GetProductByIdService> logger) : IGetProductByIdService
{
    ...
    public async Task<ResponseResult<ProductDetailResponse>> ExecuteAsync(string id, CancellationToken ct)
    {
