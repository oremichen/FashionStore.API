...
{
    public void Configure(EntityTypeBuilder<Brand> b) { b.ToTable("Brands"); b.HasKey(x => x.Id); CatalogConfiguration.Id(b); b.Property(x => x.Name).HasMaxLength(150).IsRequired(); b.Property(x => x.Slug).HasMaxLength(180).IsRequired(); b.Property(x => x.WebsiteUrl).HasColumnType("text"); b.Ignore(x => x.ImageData); b.Property(x => x.ImageContentType).HasMaxLength(100); b.Property(x => x.ImageFileName).HasMaxLength(255); b.Property(x => x.ImageUrl).HasMaxLength(2048); b.HasIndex(x => x.Name).IsUnique().HasDatabaseName("BrandsNameUnique"); b.HasIndex(x => x.Slug).IsUnique().HasDatabaseName("BrandsSlugUnique"); }
}
public sealed class MainCarouselConfiguration : IEntityTypeConfiguration<MainCarousel>
{
    public void Configure(EntityTypeBuilder<MainCarousel> b)
    {
        ...
        b.Ignore(x => x.ImageData); b.Property(x => x.ImageUrl).HasMaxLength(2048).IsRequired(false);
        b.Property(x => x.ImageContentType).HasMaxLength(100).IsRequired(); b.Property(x => x.ImageFileName).HasMaxLength(255);
        b.Property(x => x.SortOrder).HasDefaultValue(0); b.Property(x => x.IsActive).HasDefaultValue(true);
        b.ToTable(t =>
        {
...
public sealed class PromotionBannerConfiguration : IEntityTypeConfiguration<PromotionBanner>
{
    public void Configure(EntityTypeBuilder<PromotionBanner> b)
    {
        ...
        b.Property(x => x.IsActive).HasDefaultValue(false); b.Ignore(x => x.ImageData); b.Property(x => x.ImageUrl).HasMaxLength(2048).IsRequired(false);
...
public sealed class ProductImageConfiguration : IEntityTypeConfiguration<ProductImage> { public void Configure(EntityTypeBuilder<ProductImage> b) { b.ToTable("ProductImages"); b.HasKey(x=>x.Id); CatalogConfiguration.Id(b); b.Property(x=>x.ProductId).HasMaxLength(50); b.Property(x=>x.AlternativeText).HasMaxLength(250); b.Ignore(x=>x.SmallImageData); b.Ignore(x=>x.MediumImageData); b.Ignore(x=>x.ImageData); b.Property(x=>x.ImageContentType).HasMaxLength(100); b.Property(x=>x.ImageFileName).HasMaxLength(255); b.Property(x=>x.SmallUrl).HasMaxLength(2048).IsRequired(false); b.Property(x=>x.MediumUrl).HasMaxLength(2048).IsRequired(false); b.Property(x=>x.BigUrl).HasMaxLength(2048).IsRequired(false); b.HasOne(x=>x.Product).WithMany(x=>x.Images).HasForeignKey(x=>x.ProductId).OnDelete(DeleteBehavior.Cascade); b.HasIndex(x=>new{x.ProductId,x.SortOrder}).IsUnique(); } }
