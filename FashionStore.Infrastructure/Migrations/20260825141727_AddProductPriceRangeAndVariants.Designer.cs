...
namespace FashionStore.Infrastructure.Migrations
{
    ...
    [Migration("20260825141727_AddProductPriceRangeAndVariants")]
    partial class AddProductPriceRangeAndVariants
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FashionStore.Domain.Entities.ContactUs", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("FashionStore.Domain.Entities.ContactUsConfiguration", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                    ...
                    b.ToTable("ContactUsConfiguration", (string)null);
                });
            ...
            modelBuilder.Entity("FashionStore.Domain.Entities.PromotionVideo", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                    ...
                    b.HasIndex("IsActive")
                        .IsUnique()
                        .HasDatabaseName("PromotionVideosOneActiveUnique")
                        .HasFilter("\"IsActive\" = TRUE");

                    b.HasIndex("Slug")
                        .IsUnique()
                        .HasDatabaseName("PromotionVideosSlugUnique");

                    b.ToTable("PromotionVideos", (string)null);
                });
