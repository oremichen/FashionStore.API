...
namespace FashionStore.Application.Features.PromotionVideos;

public sealed class PromotionVideoService(IPromotionVideoRepository repository, ICloudinaryVideoService cloudinary) : IPromotionVideoService
{
